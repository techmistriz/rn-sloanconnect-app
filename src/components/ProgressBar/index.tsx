 ...
 **/
const rotateByStyle = (percent: number, base_degrees: any, clockwise: any) => {
...
const CircularProgress = ({
  ...
  textFontColor: any;
  otherText: any;
  otherTextStyle: TextProps;
  symbolText: any;
  symbolTextFontSize: any;
  symbolTextFontColor: any;
  symbolTextFontWeight: any;
  symbolTextMarginTop: any;
  clockwise: any;
  bgColor: any;
  startDegrees: any;
}) => {
      ...
      <View style={[styles.textContainerMain]}>
        <View style={[styles.textContainer]}>
          ...
          <Text
            style={[
              {
                fontSize: symbolTextFontSize,
                fontWeight: symbolTextFontWeight,
                color: symbolTextFontColor,
                marginTop: symbolTextMarginTop,
              },
            ]}>
            {symbolText}
          </Text>
        ...
        {otherText != '' && (
          <View style={[styles.textContainer]}>
            <Text style={[styles.otherText, otherTextStyle]}>{otherText}</Text>
          </View>
        )}
      </View>
    </View>
...
CircularProgress.defaultProps = {
  ...
  otherTextStyle: {},
  symbolText: '',
  symbolTextFontSize: 12,
  symbolTextFontColor: '#fff',
  symbolTextFontWeight: 'normal',
  symbolTextMarginTop: 13,
  clockwise: false,
  bgColor: '#fff',
  startDegrees: 0,
};

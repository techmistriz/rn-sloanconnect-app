...
const API_LEVEL = parseInt(Platform.Version.toString(), 10);
const TOTAL_PERMISSION_REQUIRED = API_LEVEL <= 30 ? 4 : 2;
...
const ANDROID_APP_VERSION = '1.2.7';
const ANDROID_RELEASE_DATE = 'Oct 10, 2024';
const IOS_APP_LINK =
  'https://play.google.com/store/apps/details?id=app.appID&pli=1';
const IOS_APP_VERSION = '1.2.7';
const IOS_APP_RELEASE_DATE = 'Oct 10, 2024';
